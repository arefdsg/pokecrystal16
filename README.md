...
* `base-components`: (status: **stable**, last update: **2020-05-25**) This branch defines the basic components that
  ...
  `master`.
* `expand-mon-ID`: (status: **stable**, last update: **2020-05-09**) This branch implements 16-bit indexes for Pokémon
